...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM_NAV] = LAYOUT_moonlander(
    _______, _______, _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, _______, _______,
    _______, FR_1,    FR_2,    FR_3,    FR_4,    FR_5,    _______,      _______, _______, _______, _______, _______, _______, _______,
    _______, FR_6,    FR_7,    FR_8,    FR_9,    FR_0,    _______,      _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, VIM_ALT, _______,
